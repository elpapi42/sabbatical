...
def resolve_last_valid_tag(text: str, valid_names: set[str]) -> tuple[str | None, list[str]]:
    """Extract all tags, then return the last one that appears in valid_names.

    Returns (last_valid_tag_or_None, all_extracted_tags).
