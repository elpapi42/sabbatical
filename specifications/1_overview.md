...
* **Cost from Runs** — The Run is the sole unit of cost. All aggregate cost and token figures (organization, agent, task) are computed at query time by summing across Runs, not stored redundantly.
