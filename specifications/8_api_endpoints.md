...
Token and cost figures are computed by summing all Runs across all organizations.
...
Token and cost figures are computed from all Runs belonging to this organization.
...
Delete an organization and **all associated data**: agents, tasks, and runs. This is a hard, irreversible delete.
